...
getUsers();
  ...
  return (
    ...
    <div className="md:full w-full  min-h-screen  p-6">
...
<div className="bg-gray-100 p-1 rounded-xl pt-4 ">
      {/* Search + Filter */}
      ...
      <div className="bg-white rounded-2xl shadow-md overflow-x-auto">
        ...
        <table className="w-full text-left">
          ...
          <tbody>
            {filteredUsers.length>0?filteredUsers.reverse().slice(0,20).map((user) => (
