...
const LearningScreenNav = ({setIsSidebarOpen,lesson ,lessons,handlePrev,handleNext}) => {
  ...
  return (
    <div className="bg-white shadow-md px-4 md:px-6  py-3 flex items-center justify-between">
      ...
      <div className="hidden md:block text-gray-600 text-sm font-medium">
        Lesson {currentLessonIndex + 1 || "Loading..."} / {totalLessons || "Loading..."}
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button onClick={handlePrev} className="flex items-center gap-1 bg-gray-100 px-2 sm:px-3 py-1 rounded hover:bg-gray-200 text-sm">
          <FiChevronLeft />
          <span className="hidden sm:inline">Prev</span>
        </button>

        <button onClick={handleNext} className="flex items-center gap-1 bg-blue-600 text-white px-2 sm:px-3 py-1 rounded hover:bg-blue-700 text-sm">
